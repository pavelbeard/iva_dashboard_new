/**
 * @typedef { import('vendors/sweetalert/src/sweetalert2').default } SweetAlert2
 * @typedef { import('vendors/sweetalert/src/sweetalert2').SweetAlertOptions } SweetAlertOptions
 * @typedef { import('vendors/sweetalert/src/sweetalert2').SweetAlertIcon } SweetAlertIcon
 * @typedef { import('vendors/sweetalert/src/sweetalert2').SweetAlertInput } SweetAlertInput
 */
