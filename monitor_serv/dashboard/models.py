...
class CPU(models.Model):
    ...
    metrics = JSONField(default=default_json_value, verbose_name="Метрики:")
...
class Process(models.Model):
    uuid_record = fields.UUIDField(default=uuid.uuid4, primary_key=True, editable=False)
    metrics = JSONField(default=default_json_value, verbose_name="Процессы:")
...
class Uptime(models.Model):
    uuid_record = fields.UUIDField(default=uuid.uuid4, primary_key=True, editable=False)
    metrics = JSONField(default=default_json_value, verbose_name="Время работы сервера:")
