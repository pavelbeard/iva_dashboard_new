...
class CPUAdmin(admin.ModelAdmin):
    ...
    list_display = ('uuid_record', 'metrics', 'get_record_date', 'get_targets')
    ordering = ('-record_date',)
...
class RAMAdmin(admin.ModelAdmin):
    ...
    #                     'get_targets')
    list_display = ('uuid_record', 'metrics', 'get_record_date',
                    'get_targets')
    ordering = ('-record_date',)
    ...
    readonly_fields = ('metrics', 'record_date', 'target')
...
class NetInterfaceAdmin(admin.ModelAdmin):
    ...
    list_display = ('uuid_record', 'metrics', 'get_targets')
    ordering = ('-record_date',)
    readonly_fields = ('metrics', 'record_date', 'target')
    # readonly_fields = (
