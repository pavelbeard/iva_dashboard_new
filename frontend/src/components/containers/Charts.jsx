  ...
  return (
    <>
      <div className="container-fluid d-flex mt-3">
        ...
        <div
          onChange={setChart.bind(this)}
          className="btn-group ps-5"
          role="group"
          aria-label="charts"
        >
          <input
            ...
            readOnly={true}
          />
          <label className="btn btn-outline-primary" htmlFor="system">
            System
          </label>
          <input
            type="radio"
            ...
            readOnly={true}
          />
          <label className="btn btn-outline-primary" htmlFor="network">
            Network
          </label>
          <input
            type="radio"
            ...
            autoComplete="off"
            value="modules"
            checked={"modules" === value}
            readOnly={true}
          />
          <label className="btn btn-outline-primary" htmlFor="modules">
            Modules
          </label>
        </div>
      </div>
