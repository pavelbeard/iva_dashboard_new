...
import LoggedAs from "../auth/LoggedAs";
...
const Header = () => {
  ...
  const defaultRefreshInterval = useSelector(
    (state) => state.refresh.refreshInterval,
  );
